...
pub struct Coordinator2 {
    ...
    server_list: Mutex<Vec<Arc<Mutex<Server2>>>>,
...
impl Coordinator2 {
    ...
    pub fn scale_to(&self, num_servers: u32) {
        ...
        if *no_active_servers_guard < num_servers {
            ...
            while *no_active_servers_guard < num_servers {
                let server = Server2::new(self.database.clone(), self.reservation_timeout);
    ...
    pub fn get_server(&self, id: Uuid) -> Arc<Mutex<Server2>> {
